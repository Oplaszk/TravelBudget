    ...
    public class DBContact : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Travel>().HasData(
               new Travel() { Id = 1, StartingDate = new DateTime(2022, 12, 12, 06, 15, 0), FinishDate = new DateTime(2022, 12, 16, 21, 15, 0), Name = "Around Poland", Description = "Visiting castles around Poland", Active = false, CommentId = 1, },
